<html <?php language_attributes(); ?>>
  <head>
    ...
    <script type="text/javascript" src="/bootstrap/js/bootstrap.js"></script>
		...
		<!-- Files 4 Iview Slider -->
		<script src="wp-content/themes/run4fun/js/jquery-1.7.1.min.js"></script>
		<script src="wp-content/themes/run4fun/js/iview.js"></script>
		<script type="text/javascript" src="wp-content/themes/run4fun/js/raphael-min.js"></script>
		<script type="text/javascript" src="wp-content/themes/run4fun/js/jquery.easing.js"></script>
